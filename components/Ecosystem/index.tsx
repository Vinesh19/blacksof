...
const Ecosystem = () => {
  return (
    <section className="px-[10%] xl:px-[14%] py-24 bg-gradient-to-r from-[#FFFFFF] from-10% via-[#e6f4ffdb] via-40% to-[#ECF7FF] to-80% ">
      <div className="max-w-[600px]">
        <p className="bg-gradient-to-r from-[#97abf4] text-[#00386B] w-12 h-12 text-2xl py-2 px-8 font-semibold">
          Ecosystem
        </p>
        <p className="text-5xl leading-tight mt-5">
      ...
      <div className="mt-20">
        <div className="flex">
          ...
          <div className="flex flex-col grow relative">
            <div className="border-t-[3px] border-dashed w-full absolute top-1/4"></div>
          </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="relative h-20">
            ...
            <div className="border-r-[3px] border-dashed absolute right-[33%] h-4"></div>
          </div>
